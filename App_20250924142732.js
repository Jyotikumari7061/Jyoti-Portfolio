        ...
        <div style={{ textAlign: 'center', position: 'relative', zIndex: 10, maxWidth: '1200px', padding: '0 2rem' }}>
          ...
          <div style={{ marginBottom: '3rem' }}>
            <div style={{ position: 'relative', display: 'inline-block' }}>
              <img
                src="/image/jyoti.jpg"  // ← **CRITICAL: REPLACE 'jyoti.jpg' WITH YOUR EXACT FILENAME** (e.g., /image/profile.png or /image/IMG_1234.jpg). Move file to public/image/ first!
                ...
                style={{
                  ...
                  borderRadius: '24px',
                  objectFit: 'cover',
                  border: '4px solid rgba(255, 255, 255, 0.8)',  // Visible white border
                  boxShadow: '0 20px 40px rgba(0, 0, 0, 0.3)',
                  display: 'block',  // Ensures it's shown
                  position: 'relative',
                  zIndex: 2,  // On top
                  backgroundColor: '#f0f0f0'  // Light gray bg for debug (remove after fixing)ebug)
                }}
