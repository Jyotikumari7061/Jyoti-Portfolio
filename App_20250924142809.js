            ...
            <div style={{ position: 'relative', display: 'inline-block' }}>
              <img
                ...
                style={{
                  ...
                  onLoad={() => console.log('YOUR IMAGE LOADED SUCCESSFULLY! (From public/image/)')}  // Confirms your image
                onError={(e) => {
                  console.error('YOUR IMAGE FAILED TO LOAD. Check: 1) Exact filename in public/image/? 2) Restarted npm start? 3) Direct URL http://localhost:3000/image/[filename]? Using fallback...');
                  // Fallback 1: External reliable image (not yours, but visible)
                  e.target.src = 'https://picsum.photos/200/200?random=jyoti';  // Random photo (temporary)
                  e.target.onerror = (err) => {
                    // Fallback 2: Inline SVG (blue square - always works)
                    e.target.src = 'data:image/svg+xml;base64,';
                    e.target.style.border = '4px solid red';  // Red border to spot fallback
