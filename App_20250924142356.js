    ...
    <div className="App">
      ...
      style={{
        ...
        backgroundColor: '#f0f0f0'  // Light bg if image fails (temporary debug)
                ...
                onError={(e) => {
                  console.error('Local image failed to load. Check filename/path in public/image/. Using fallback.');  // Debug log
                  // Inline SVG fallback (blue square with text - always visible, no external load)
                  e.target.src = 'data:image/svg+xml;base64,';
                  e.target.onerror = null;  // Prevent loop
                  e.target.style.border = '4px solid #ff6b6b'; 
                }}
              />
              <div style={{
                position: 'absolute',
